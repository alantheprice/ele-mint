import { register, registerComponent, Component } from "../src/index.js";
...
notes.push({
  ...
  message:
    "I really enjoyed this going here. The food was good, and relatively quick, the server was attentive, but not stiffling. This might become my standby.",
});
notes.push({
  date: new Date().toISOString(),
...
function test() {
  ...
  App({ startingNotes: notes }).mount(
    document.getElementsByClassName("mount-point")[0]
  );
}
